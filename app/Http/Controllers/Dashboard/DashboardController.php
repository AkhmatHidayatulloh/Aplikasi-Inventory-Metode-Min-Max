...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $pending = TransaksiBarangKeluar::where('status', '=', 'pending')->count();
        ...
        return view('dashboard.pages.dashboard', compact('supplier', 'customer', 'transaksi_masuk', 'transaksi_keluar', 'namabarang', 'pending'));
    }
}